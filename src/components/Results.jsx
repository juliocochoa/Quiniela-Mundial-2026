      ...
      <div className="flex flex-col md:flex-row md:items-end justify-between mb-10 gap-gutter animate-in fade-in duration-500">
        <div>
          ...
          <p className="text-on-surface-variant mt-2 max-w-xl">
            Sigue todos los resultados del torneo.
          </p>
        </div>
          ...
          {filteredMatches.map((match) => {
            ...
            return (
              ...
              >
                ...
                >
                  <span
                    className={`text-label-sm font-label-sm uppercase flex items-center gap-2 tracking-wider ${
                      isLive
                        ? "text-on-secondary"
                  ...
                  <div className="flex items-center justify-between gap-4 w-full">
                    ...
                    <div className="flex flex-col items-center flex-1">
                      <div className="w-16 h-16 rounded-full border border-outline-variant shadow-sm mb-3 overflow-hidden transition-all group-hover:scale-105">
                        <img
                          ...
                          src={`https://flagcdn.com/w160/${getCountryCode(match.home)}.png`}
                        />
                      </div>
                      <span className="font-bold text-lg text-center text-on-surface">
                        {match.home}
                      </span>
                    </div>
                    ...
                    <div className="flex flex-col items-center gap-1">
                      <div className="flex items-center gap-3">
                        ...
                        <span className="text-on-surface-variant font-bold opacity-30">
                          —
                        </span>
                        <span className="text-5xl font-display-lg text-primary">
                          {match.away_score ?? "-"}
                    ...
                    <div className="flex flex-col items-center flex-1">
                      <div className="w-16 h-16 rounded-full border border-outline-variant shadow-sm mb-3 overflow-hidden transition-all group-hover:scale-105">
                        <img
                          alt={match.away}
                          className="w-full h-full object-cover"
                          src={`https://flagcdn.com/w160/${getCountryCode(match.away)}.png`}
                        />
                      </div>
                      <span className="font-bold text-lg text-center text-on-surface">
                        {match.away}
