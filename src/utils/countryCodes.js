...
export const getCountryCode = (countryName) => {
  ...
  for (const [code, name] of Object.entries(flagcdnEsCodes)) {
    if (normalize(name) === normalizedTarget) {
      return code;
    }
  }
  
  // Custom aliases and fallbacks for common names not exactly matching the JSON
  if (normalizedTarget === 'usa' || normalizedTarget === 'estados unidos de america') return 'us';
  
  return 'xx'; // Fallback for unknown
};
